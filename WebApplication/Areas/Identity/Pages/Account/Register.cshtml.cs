...
namespace WebApplication.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "{0} длинной должени быть минимум {2} и мксумум {1}.", MinimumLength = 6)]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (_userManager.Options.SignIn.RequireConfirmedAccount)
                    {
                        ...
                        var resultConfirmEmail = await _userManager.ConfirmEmailAsync(user, codeDecoded);
